...
while(True):
    ...
    manifest["spec"]["scheduler"]["spec"]["containers"][0]["image"] = "ghcr.io/tommasodiotalevi/jlab:wp5-alma9-" + os.environ.get("IMAGE_TAG") 
    manifest["spec"]["worker"]["spec"]["containers"][0]["image"] = "ghcr.io/tommasodiotalevi/jlab:wp5-alma9-" + os.environ.get("IMAGE_TAG") 
